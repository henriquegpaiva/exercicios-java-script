...
frutas.push("Morango");
console.log("O array agora é:", frutas); // Saida: O array agora é: ['Maçã', 'Banana', 'Laranja', 'Uva', 'Morango']

// Removendo o último elemento do array
frutas.pop();
console.log("O array após remover o último elemento:", frutas); // Saida: O array após remover o último elemento: ['Maçã', 'Banana', 'Laranja', 'Uva']
